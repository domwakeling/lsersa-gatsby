...
const sendNewAccountEmailToUser = async (token, email) => {
            ...
            <table class="column" style="border-spacing:0;padding-left:8px;padding-right:8px;">
                ...
                <tr>
                    <td class="row" style="padding:0;padding-bottom:16px;">
                        Your account request has been accepted. Please follow <a
                        href="https://lsersa.org/validateuser/${token}">this link</a>
...
`
    ...
    const newBodyText = `Your account request has been accepted. Please follow this link
